...
export const dadosCadastraisSchema = z.object({
  ...
  empresaNumero: z.string().trim().optional().default(""),
  empresaBairro: z.string().trim().optional().default(""),
  ...
  estabelecimentoEndereco: z.string().trim(),
  estabelecimentoNumero: z.string().trim().optional().default(""),
  estabelecimentoBairro: z.string().trim().optional().default(""),
  estabelecimentoCep: z.string().trim(),
  estabelecimentoCidade: z.string().trim(),
  estabelecimentoEstado: z.string().trim(),
  ...
  contratanteNumero: z.string().trim().optional().default(""),
  contratanteBairro: z.string().trim().optional().default(""),
});
